...
//        PositionShopping positionShopping1 = mapper.readValue(positionShopping, PositionShopping.class);
    ...
    public ResponseEntity update(@RequestBody PositionShopping positionShopping) throws JsonProcessingException {
        System.out.println(positionShopping.getProdyct().getName());
        System.out.println(positionShopping.getId());
